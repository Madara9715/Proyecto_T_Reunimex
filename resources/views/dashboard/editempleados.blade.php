                ...
                <div class="row m-1 border border-left-0 border-right-0 border-top-0">  
                    ...
                    <div class="col-md-9 justify-content-center">
                       ...
                       <select class="custom-select" name="tipoempleado_id">
                        <option selected value='{{$tipoempleadoA->id}}'>{{$tipoempleadoA->nombre_tipoE}}</option>
                ...
                <div
                    ...
                    <div class="col-md-9 justify-content-center">
                       ...
                       <select class="custom-select" name="departamento_id">
                        <option selected value='{{$departamentoA->id}}'>{{$departamentoA->nombre_departamento}}</option>
                    ...
                    <div class="col-md-9 justify-content-center">
                        ...
                        <span
                            class="textdarkgray text-capitalize font-weight-bold bigtitle"></span>
                        <input type="text" class="form-control border30p nofont inputblack" value="{{$empleado->nombre_empleado}}" name="nombre_empleado">
                    ...
                    <div class="col-md-9 justify-content-center">
                        ...
                        <span
                            class="textdarkgray text-capitalize font-weight-bold bigtitle"></span>
                        <input type="text" class="form-control border30p nofont inputblack" value="{{$empleado->apellido_p}}" name="apellido_p">
                    </div>
                    ...
                    <div class="col-md-9 justify-content-center">
                        ...
                        <span
                            class="textdarkgray text-capitalize font-weight-bold bigtitle"></span>
                        <input type="text" class="form-control border30p nofont inputblack" value="{{$empleado->apellido_m}}" name="apellido_m">
                    ...
                    <div class="col-md-9 justify-content-center">
                        ...
                        <span
                            class="textdarkgray text-capitalize font-weight-bold bigtitle"></span>
                        <input type="text" class="form-control border30p nofont inputblack" value="{{$empleado->telefono_fijo}}" name="telefono_fijo">
                    ...
                    <div class="col-md-9 justify-content-center">
                        ...
                        <span
                            class="textdarkgray text-capitalize font-weight-bold bigtitle"></span>
                        <input type="text" class="form-control border30p nofont inputblack" value="{{$empleado->telefono_movil}}" name="telefono_movil">
                    </div>
                    ...
                    <div class="col-md-9 justify-content-center">
                        ...
                        <span
                            class="textdarkgray text-capitalize font-weight-bold bigtitle"></span>
                        <input type="text" class="form-control border30p nofont inputblack" value="{{$empleado->direccion}}" name="direccion">
                    ...
                    <div class="col-md-9 justify-content-center">
                        ...
                        <span
                            class="textdarkgray text-capitalize font-weight-bold bigtitle"></span>
                        <input type="email" class="form-control border30p nofont inputblack" value="{{$empleado->correo_electronico}}" name="correo_electronico">
                    ...
                    <div class="col-md-9 justify-content-center">
                        ...
                        <span
                            class="textdarkgray text-capitalize font-weight-bold bigtitle"></span>
                        <input type="text" class="form-control border30p nofont inputblack" value="{{$empleado->edad}}" name="edad">
                    ...
                    <div class="col-md-9 justify-content-center">
                        ...
                        <select class="custom-select" name="sexo">
                            <option selected value='{{$empleado->activo}}'>
                            @if(($empleado->sexo) =='1')
                            Masculino
                            @else
                            Femenino
