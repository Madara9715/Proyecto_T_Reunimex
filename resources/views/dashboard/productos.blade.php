                    ...
                    <table class="table table-sm table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-capitalize text-primary font-weight-bolder">{{$producto->nombre_producto}}</td>
...
@include('dashboard.newpre_'.$nuevo)
...
$(document).ready(function() {
    ...
    $('#DeleteSubmit').click(function(e) {
        ...
        var dltUrl = "productos" + "/" + $('#DeleteId').val();
        $.ajax({
            url: dltUrl,
            type: "DELETE",
            cache: false,
...
function delete_click(clicked_id) {
    $.get("borrar" + "/" + clicked_id + "/" + "producto", function(data) {
