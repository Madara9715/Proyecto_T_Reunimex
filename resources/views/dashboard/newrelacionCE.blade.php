<div class="modal fade" id="asignacion">
    <div class="modal-dialog modal-lg modal-dialog-centered d-flex flex-column">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header fontgradradiant text-uppercase espacioletras py-3 justify-content-center">
                <h5 class="modal-title text-light align-self-center lineagradien2">nueva asignación</h5>
            </div>

            <form action="{{ route('clienteempleado') }}" method="POST">
                @csrf
                        ...
                        <div class="col-lg-9">
                            <div class="form-group">
                                ...
                                <select class="custom-select " name="empleado_id">
                                    ...
                                    <option value={{$valueEmpleado}}> {{$empleado->clave}}| {{$empleado->nombre_empleado}} {{$empleado->apellido_p}} {{$empleado->apellido_m}} </option>
                                    @endforeach
                                </select>
