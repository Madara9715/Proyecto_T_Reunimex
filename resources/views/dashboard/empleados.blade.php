                    ...
                    <table class="table table-sm table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td >{{$empleado->nombre_empleado}} {{$empleado->apellido_p}} {{$empleado->apellido_m}}</td>
                                ...
                                <td>
                                    ...
                                    <div class="row justify-content-end mr-1">
                                        ...
                                        <div class="col-sm-4 mt-1 px-1 d-flex justify-content-center">
                                            <a id="{{$empleado->id}}" href="{{ route('empleados.edit',$empleado->id) }}"
                                        ...
                                        <div class="col-sm-4 mt-1 px-1 d-flex justify-content-center">
                                             <button value="{{$empleado->id}}" onclick="delete_click(this.value)"
...
@include('dashboard.newrelacionCE')
...
$(document).ready(function() {
    ...
    $('#DeleteSubmit').click(function(e) {
        ...
        var dltUrl = "empleados" + "/" + $('#DeleteId').val();
        $.ajax({
            url: dltUrl,
            type: "DELETE",
            cache: false,
...
function delete_click(clicked_id) {
    $.get("borrar" + "/" + clicked_id+ "/" +"empleado", function(data) {
