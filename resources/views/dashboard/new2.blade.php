        ...
        <div class="modal-content">
            ...
            <form id="CrearNuevo">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="text-danger mt-2">
                                <span id="OcultNewErrorMessages" class="justify-content-center p-2" style="display:none">
                                ...
                                <div id="NewErrorMessages" class="alert-danger text-muted bg-dark border30p p-2 px-5 my-2 font-weight-bold" style="display:none">
                                </div>
                            </div>
                ...
                <div class="modal-footer justify-content-center nofont">
                    ...
                    <button type="button" class="btn bt2 fontgradradiant" id="NuevoSubmit">
